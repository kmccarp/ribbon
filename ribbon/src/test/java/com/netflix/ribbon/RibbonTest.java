...
public class RibbonTest {
    ...
    public void testCommandWithMetaData() throws IOException, InterruptedException, ExecutionException {
        ...
        Observable<String> result = metaRequest.toObservable().flatMap(
                response -> {
    ...
    public void testFallback() throws IOException {
        ...
        Observable<String> result = request.withMetadata().toObservable().flatMap(
                response -> {
    ...
    public void testObserve() throws IOException, InterruptedException {
        ...
        result2 = metaResult.flatMap(RibbonResponse::content).map(t1 -> t1.toString(Charset.defaultCharset())).toBlocking().single();
